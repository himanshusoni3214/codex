...
use App\Filament\Resources\GemstoneTypeResource\Pages;
...
class GemstoneTypeResource extends Resource
{
    protected static ?string $model = GemstoneType::class;
    ...
    {
        return [
            'index' => Pages\ListGemstoneTypes::route('/'),
            'create' => Pages\CreateGemstoneType::route('/create'),
            'edit' => Pages\EditGemstoneType::route('/{record}/edit'),
        ];
    }
