...
<section class="max-w-6xl mx-auto px-4 py-16 space-y-8">
    ...
    <div class="bg-white rounded-3xl p-8 shadow-lux border border-platinum space-y-4">
        ...
        <p class="text-midnight-600">For privacy questions, email us at <?php echo e($settings['contact_email'] ?? 'hello@naturalgem.com'); ?>.</p>
    </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Himanshu/Documents/Mac Documents/naturalgem/resources/views/pages/privacy.blade.php ENDPATH**/ ?>