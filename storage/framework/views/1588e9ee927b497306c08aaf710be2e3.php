...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['href' => ''.e(route('admin.testimonials.create')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('admin.testimonials.create')).'']); ?>Add Testimonial <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-t">
                        <td class="p-4"><?php echo e($testimonial->name); ?></td>
                        <td class="p-4"><?php echo e($testimonial->rating); ?></td>
                        <td class="p-4"><?php echo e($testimonial->is_featured ? 'Yes' : 'No'); ?></td>
                        <td class="p-4 text-right space-x-2">
                            <a href="<?php echo e(route('admin.testimonials.edit', $testimonial)); ?>" class="text-emerald-700">Edit</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Himanshu/Documents/Mac Documents/naturalgem/resources/views/admin/testimonials/index.blade.php ENDPATH**/ ?>