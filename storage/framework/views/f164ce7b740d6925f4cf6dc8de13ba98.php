...
<?php $component = Illuminate\View\DynamicComponent::resolve(['component' => static::isSimple() ? 'filament-panels::page.simple' : 'filament-panels::page'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-panels::components.form.index','data' => ['id' => 'form','wire:submit' => 'save']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /Users/Himanshu/Documents/Mac Documents/naturalgem/vendor/filament/filament/resources/views/pages/auth/edit-profile.blade.php ENDPATH**/ ?>