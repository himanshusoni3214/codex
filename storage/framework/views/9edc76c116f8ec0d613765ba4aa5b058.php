...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-tiptap-editor::components.button','data' => ['xShow' => 'tools.includes(\'color\') && editor().isActive(\'textStyle\', updatedAt)','style' => 'display: none;','action' => 'editor().chain().focus().unsetColor().run()','label' => ''.e(trans('filament-tiptap-editor::editor.remove_color')).'','icon' => 'remove-color']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-show' => 'tools.includes(\'color\') && editor().isActive(\'textStyle\', updatedAt)','style' => 'display: none;','action' => 'editor().chain().focus().unsetColor().run()','label' => ''.e(trans('filament-tiptap-editor::editor.remove_color')).'','icon' => 'remove-color']); ?>
...
<?php endif; ?><?php /**PATH /Users/Himanshu/Documents/Mac Documents/naturalgem/vendor/awcodes/filament-tiptap-editor/resources/views/components/tools/remove-color.blade.php ENDPATH**/ ?>