...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($page->related_links)): ?>
        <section class="bg-white rounded-3xl p-6 border border-platinum shadow-lux">
            ...
            <div class="mt-4 grid md:grid-cols-2 gap-3 text-sm">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $page->related_links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($link['url'] ?? '#'); ?>" class="rounded-2xl border border-platinum bg-ivory px-4 py-3 hover:border-emerald-500">
                        <?php echo e($link['label'] ?? 'Learn more'); ?>
