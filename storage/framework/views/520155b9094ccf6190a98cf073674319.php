<header class="bg-white/90 backdrop-blur border-b border-platinum sticky top-0 z-40">
    <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav class="hidden lg:flex items-center gap-6 text-sm font-medium">
            <a href="<?php echo e(route('gemstones')); ?>" class="hover:text-emerald-700">Gemstones</a>
            <a href="<?php echo e(route('education')); ?>" class="hover:text-emerald-700">Education</a>
            <a href="<?php echo e(route('about')); ?>" class="hover:text-emerald-700">About</a>
            <a href="<?php echo e(route('consultation')); ?>" class="hover:text-emerald-700">Traditional Consultation</a>
            <a href="<?php echo e(route('testimonials')); ?>" class="hover:text-emerald-700">Reviews</a>
            <a href="<?php echo e(route('contact')); ?>" class="hover:text-emerald-700">Contact</a>
        </nav>

        <div class="hidden lg:flex items-center gap-3">
            <span class="text-sm text-midnight-500"><?php echo e($settings['contact_phone'] ?? '+1 (647) 555-0199'); ?></span>
