<header class="bg-white/90 backdrop-blur border-b border-platinum sticky top-0 z-40">
    <div class="max-w-7xl mx-auto px-4 py-4 flex items-center gap-6">
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 shrink-0 lg:min-w-[270px]">
            <img src="<?php echo e($settings['logo_path'] ?? '/images/natural-gem-logo.svg'); ?>" alt="Natural Gem" class="h-10 w-10">
            <div class="leading-tight">
                <p class="font-display text-lg text-midnight-900"><?php echo e($settings['site_name'] ?? 'Natural Gem'); ?></p>
        ...
        <nav class="hidden lg:flex flex-1 items-center justify-center gap-4 xl:gap-6 text-sm font-medium whitespace-nowrap">
            <a href="<?php echo e(route('gemstones')); ?>" class="hover:text-emerald-700 transition-colors">Gemstones</a>
            <a href="<?php echo e(route('gemstones')); ?>#browse-by-type" class="hover:text-emerald-700 transition-colors">Browse by Gemstone Type</a>
            <a href="<?php echo e(route('gemstones')); ?>#browse-by-origin" class="hover:text-emerald-700 transition-colors">Browse by Origin</a>
            <a href="<?php echo e(route('education')); ?>" class="hover:text-emerald-700 transition-colors">Education</a>
            <a href="<?php echo e(route('about')); ?>" class="hover:text-emerald-700 transition-colors">About</a>
            <a href="<?php echo e(route('consultation')); ?>" class="hover:text-emerald-700 transition-colors">Traditional Consultation</a>
            <a href="<?php echo e(route('testimonials')); ?>" class="hover:text-emerald-700 transition-colors">Reviews</a>
            <a href="<?php echo e(route('contact')); ?>" class="hover:text-emerald-700 transition-colors">Contact</a>
        </nav>

        <div class="hidden lg:flex items-center gap-3 shrink-0">
            <span class="hidden xl:inline text-sm text-midnight-500 whitespace-nowrap"><?php echo e($settings['contact_phone'] ?? '+1 (647) 555-0199'); ?></span>
            <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['href' => ''.e(route('gemstones')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('gemstones')).'']); ?>Shop Gemstones <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
